...
const Strategy = artifacts.require("BalancerStrategyMainnet_wstETH_aWETH");

// Developed and tested at blockNumber 95047800

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Balancer wstETH-aWETH", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x5A7f39435fD9c381e4932fa2047C9a5136A5E3E7");
