...
const Strategy = artifacts.require("PenpieStrategyMainnet_wstETH2706");

// Developed and tested at blockNumber 204652000

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Penpie wstETH", function () {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x12478d1a60a910C9CbFFb90648766a2bDD5918f5";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xFd8AeE8FCC10aac1897F8D5271d112810C79e022");
