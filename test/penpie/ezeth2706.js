...
const Strategy = artifacts.require("PenpieStrategyMainnet_ezETH2706");

// Developed and tested at blockNumber 204652000

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Penpie ezETH", function () {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x8348bFD127E5e1A2Be1849358Ca7238be1b06311";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x5E03C94Fc5Fb2E21882000A96Df0b63d2c4312e2");
