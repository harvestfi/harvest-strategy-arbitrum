...
const Strategy = artifacts.require("AaveSupplyStrategyMainnet_GHO");

//This test was developed at blockNumber 228381000

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Aave GHO", function() {
  let accounts;
  ...
  let ifarm = "0x9dCA587dc65AC0a043828B0acd946d71eb8D46c1"
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x7dfF72693f6A4149b17e7C6314655f6A9F7c8B33");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [
        {"balancer": [gho, aaveUSDCn, usdc]},
        {"camelot": [usdc, weth, ifarm]},
      ],
      "balancerPool": [
        [usdc, aaveUSDCn, "0xca8ecd05a289b1fbc2e0eaec07360c4bfec07b6100020000000000000000051d"],
        [gho, aaveUSDCn, "0x46472cba35e6800012aa9fcc7939ff07478c473e00020000000000000000056c"],
      ]
    });
