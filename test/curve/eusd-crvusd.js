...
const Strategy = artifacts.require("CurveStrategyMainnet_eUSD_crvUSD");

// Developed and tested at blockNumber 227919050

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Curve eUSD-crvUSD", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x07c8F38a8482A2d7841C79dECD59e1c69901Cd67";
  let weth = "0x82aF49447D8a07e3bd95BD0d56f35241523fBab1";
  let rsr = "0xCa5Ca9083702c56b481D1eec86F1776FDbd2e594";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x67D11005AF05Bb1e9fDb1CFc261C23DE3E1055a1");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      // "curvePool": [
      //   [rsr, eusd, "0x45B47fE1bed067de6B4b89e0285E6B571A64c57C"],
      // ],
      "ULOwner": addresses.ULOwner
    });
