...
const Strategy = artifacts.require("CurveStrategyMainnet_eUSD_USDC");

// Developed and tested at blockNumber 227919050

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Curve eUSD-USDC", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x93a416206B4ae3204cFE539edfeE6BC05a62963e");
