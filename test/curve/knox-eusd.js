...
const Strategy = artifacts.require("CurveStrategyMainnet_KNOX_eUSD");

// Developed and tested at blockNumber 227919050

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Curve KNOX-eUSD", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x6f33daF91d2aCAe10F5CD7BbE3f31716Ed123F1D");
