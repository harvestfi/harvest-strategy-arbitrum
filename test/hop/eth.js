...
const Strategy = artifacts.require("HopStrategyMainnet_ETH");

// Developed and tested at blockNumber 225609500

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet HOP WETH", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x0e5a3D70BF3B9A27d344153e4B2a0562d2E9DF54";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x59745774Ed5EfF903e615F5A2282Cae03484985a");
