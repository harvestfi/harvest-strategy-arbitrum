...
const Strategy = artifacts.require("PoisonStrategyLPMainnet_pAAPL_USDC");

// Developed and tested at blockNumber 68176000

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Poison pAAPL-USDC", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xc92FC09658fb97cCF59ffd34d404766C3713c828";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x410B7C383a0dF3c56C63E44b2e4Cb752A1350b32");
