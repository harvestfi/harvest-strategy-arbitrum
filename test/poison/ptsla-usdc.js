...
const Strategy = artifacts.require("PoisonStrategyLPMainnet_pTSLA_USDC");

// Developed and tested at blockNumber 68176000

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Poison pTSLA-USDC", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x00468cd187492080C66A96F28581881fC306f851");
