...
const Strategy = artifacts.require("PoisonStrategyLPMainnet_pSLVR_USDC");

// Developed and tested at blockNumber 68176000

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Poison pSLVR-USDC", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xE65DD5d5631C354Ab2cFE2a47C79655E68D6BF27";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x5f586464c9DF5cA0C685798B4Fa092136f087BEc");
