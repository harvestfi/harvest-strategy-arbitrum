...
const Strategy = artifacts.require("PoisonStrategyHodlMainnet_pGOLD");

const D18 = new BigNumber(Math.pow(10, 18));

//This test was developed at blockNumber 68176000

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Jarvis pGOLD HODL in iPoison", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x5c2520BF3b5905369259af57a1B135DACa159C4E";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xF602A45812040D90B202355bdc05438918CD3FE3");
