...
const Strategy = artifacts.require("AuraStrategyMainnet_DOLA_USDC");

// Developed and tested at blockNumber 114824200

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Balancer DOLA-USDC", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x8bc65Eed474D1A00555825c91FeAb6A8255C2107");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [{"uniV3": [weth, usdc]}, {"balancer": [usdc, underlying.address]}]
    });
