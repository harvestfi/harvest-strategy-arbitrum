...
const Strategy = artifacts.require("AuraStrategyMainnet_bbwstETH_bbaUSD");

// Developed and tested at blockNumber 106088800

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Balancer bbwstETH-bbUSD", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x552398406EAf406c6a9A52c7D7D3C601E588Dc98";
  let weth = "0x82aF49447D8a07e3bd95BD0d56f35241523fBab1";
  let aweth = "0xDa1CD1711743e57Dd57102E9e61b75f3587703da";
  let bbwsteth = "0x5A7f39435fD9c381e4932fa2047C9a5136A5E3E7";
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [{"balancer": [weth, aweth, bbwsteth]}]
    });
