...
// Developed and tested at blockNumber 116867555

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Balancer bb-a-USD V2", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xd4fed193AfDa571bb2faB9d26fDE9eF8054a07dF";
  let weth = "0x82aF49447D8a07e3bd95BD0d56f35241523fBab1";
  let usdc = "0xaf88d065e77c8cC2239327C5EDb3A432268e5831";
  let bbausdc = "0xbD724Eb087d4cc0f61a5fED1fFFaF937937E14DE";
  let bbausd = "0xc6EeE8cb7643eC2F05F46d569e9eC8EF8b41b389";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xc6EeE8cb7643eC2F05F46d569e9eC8EF8b41b389");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [{"balancer": [usdc, bbausdc, bbausd]}, {"camelot": [arb, weth]}]
    });
