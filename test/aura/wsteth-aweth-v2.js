...
const Strategy = artifacts.require("AuraStrategyMainnet_wstETH_aWETH_v2");

// Developed and tested at blockNumber 116865850

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Balancer wstETH-aWETH V2", function() {
  let accounts;
  ...
  let aweth = "0xaD28940024117B442a9EFB6D0f25C8B59e1c950B";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x45C4D1376943Ab28802B995aCfFC04903Eb5223f");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [{"balancer": [weth, aweth, underlying.address]}, {"camelot": [arb, weth]}]
    });
