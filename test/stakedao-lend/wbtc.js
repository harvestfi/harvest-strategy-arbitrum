...
const Strategy = artifacts.require("StakeDAOLendStrategyMainnet_Llamalend_WBTC");

//This test was developed at blockNumber 445858000

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet StakeDAO Llama Lend WBTC", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x84F4A3019197bA3Eb24905565FBBCCF775131906";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x498Bf2B1e120FeD3ad3D42EA2165E9b73f99C1e5");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [
        ...
        {"curve": [underlying.address, addresses.WETH]},
      ],
      "curveSetup": [
        [crv, underlying.address, "0x845C8bc94610807fCbaB5dd2bc7aC9DAbaFf3c55", [2, 0, 1, 3, 3]],
        [underlying.address, addresses.WETH, "0x82670f35306253222F8a165869B28c64739ac62e", [0, 2, 1, 3, 3]],
      ],
