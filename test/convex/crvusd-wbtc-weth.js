...
const Strategy = artifacts.require("ConvexStrategyMainnet_crvUSD_WBTC_WETH");

// Developed and tested at blockNumber 185049690

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Convex crvUSD-WBTC-WETH", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x4084cd5DB7B3a189e0AC575bd39f73ECa708E5FA";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x82670f35306253222F8a165869B28c64739ac62e");
