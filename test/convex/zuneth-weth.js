...
const Strategy = artifacts.require("ConvexStrategyMainnet_zunETH_WETH");

// Developed and tested at blockNumber 	266620500

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Convex zunETH-WETH", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xfdA5dFBC7d508BD831B7B2d9853349bc4280BF70";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xEBEEC2EDbbc66eB9055fe772b154f34d3dd686C8");
