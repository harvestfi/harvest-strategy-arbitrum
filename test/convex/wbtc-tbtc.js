...
const Strategy = artifacts.require("ConvexStrategyMainnet_WBTC_tBTC");

// Developed and tested at blockNumber 	266109730

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Convex WBTC-tBTC", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x186cF879186986A20aADFb7eAD50e3C20cb26CeC");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "curveSetup": [
        [weth, wbtc, "0x82670f35306253222F8a165869B28c64739ac62e", [2, 1, 1, 3, 3]],
      ],
      "ULOwner": addresses.ULOwner
    });
