...
const Strategy = artifacts.require("ConvexStrategyMainnet_OVN_stable");

// Developed and tested at blockNumber 231424500

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Convex OVN Stable", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xF00fA0C9a89bfB76ce98bC850fde366478322b66";
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "existingVaultAddress": "0x31DBd3eff737DcD45Ca8D0824A5Da94e37a79366",
