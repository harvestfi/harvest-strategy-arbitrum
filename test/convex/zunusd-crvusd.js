...
const Strategy = artifacts.require("ConvexStrategyMainnet_zunUSD_crvUSD");

// Developed and tested at blockNumber 	266620500

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Convex zunUSD-crvUSD", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x2618F4c64805526a3092d41f25597CcfE4Dd8216";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x8958AE46De6b33293DDdc6cDfbe36900f4631851");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "curveSetup": [
        [usdc, crvusd, "0xec090cf6dd891d2d014bea6edada6e05e025d93d", [1, 0, 1, 1, 2]],
      ],
      "ULOwner": addresses.ULOwner
    });
