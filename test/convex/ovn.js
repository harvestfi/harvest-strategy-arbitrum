...
const Strategy = artifacts.require("ConvexStrategyMainnet_OVN");

// Developed and tested at blockNumber 231424500

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Convex OVN", function() {
  let accounts;
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "existingVaultAddress": "0x4C9B74e52b21DDEC953daD796597D78E7EcE2A4A",
