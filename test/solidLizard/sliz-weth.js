...
const Strategy = artifacts.require("SolidLizardStrategyMainnet_SLIZ_wETH");

// Developed and tested at blockNumber 65837850

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet SolidLizard SLIZ-wETH", function () {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x1111111111111111111111111111111111111111";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x751F3B8ca139bC1F3482b193297485f14208826a");
