...
const Strategy = artifacts.require("SolidLizardStrategyMainnet_ETSGamma_USDPlus");

// Developed and tested at blockNumber 79985280

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet SolidLizard ETS Gamma - USD+", function () {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x0989865466C1F7Bf212790657A267a1D169df96a";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x97e5f60fA17816011039B908C19Fa4B43DE73731");
