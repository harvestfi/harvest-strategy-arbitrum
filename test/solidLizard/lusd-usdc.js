...
const Strategy = artifacts.require("SolidLizardStrategyMainnet_LUSD_USDC");

// Developed and tested at blockNumber 65837850

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet SolidLizard LUSD-USDC", function () {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x6FbA3e23406dBB3C010D8C203fB734b6b3EF6Dd3";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xB1E9b823295B3C69ac651C05D987B67189ff20AD");
