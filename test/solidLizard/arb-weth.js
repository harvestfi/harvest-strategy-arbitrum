...
const Strategy = artifacts.require("SolidLizardStrategyMainnet_ARB_wETH");

// Developed and tested at blockNumber 73184000

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet SolidLizard ARB-WETH", function () {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x401AA04AA584b09a14fC663703e331659BB31A69";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xCeD06c9330B02C378C31c7b12570B1C38AbfcEA6");
