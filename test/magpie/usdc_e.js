...
const Strategy = artifacts.require("MagpieStrategyMainnet_USDC_E");

// Developed and tested at blockNumber 155374400

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Magpie USDC.e", function () {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x2977b0B54a76c2b56D32cef19f8ea83Cc766cFD9");
