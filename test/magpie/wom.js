...
const Strategy = artifacts.require("MagpieStrategyMainnet_WOM");

// Developed and tested at blockNumber 155559000

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Magpie WOM", function () {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x93222d8cD2adbFb16158810De56D848fcBf3b25C";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x59d8DCA660b71Ba97a16f781A40809a0fC350769");
