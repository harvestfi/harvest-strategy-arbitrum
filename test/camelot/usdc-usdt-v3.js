...
const Strategy = artifacts.require("CamelotV3NitroStrategyMainnet_USDC_USDT");
const IXGrail = artifacts.require("IXGrail");
const IVault = artifacts.require("IVault");

const D18 = new BigNumber(Math.pow(10, 18));

//This test was developed at blockNumber 182583670

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Camelot USDC-USDT V3 HODL in xGRAIL", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x59f2B68AE6c13c69C0b6475DDD219dfbCAa4FA31";
