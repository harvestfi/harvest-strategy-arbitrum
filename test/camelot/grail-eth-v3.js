...
const Strategy = artifacts.require("CamelotV3NitroStrategyMainnet_GRAIL_ETH");
...
describe("Mainnet Camelot GRAIL-ETH V3 HODL in xGRAIL", function() {
  let accounts;
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        underlyingPrice = new BigNumber(439490/179.692239).times(D18);
