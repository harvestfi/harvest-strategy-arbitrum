...
const Strategy = artifacts.require("CamelotV3NitroStrategyMainnet_GMX_ETH");
...
describe("Mainnet Camelot GMX-ETH V3 HODL in xGRAIL", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x8E13649613B774Ab67D1C1eDfc22a2202270fD81";
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        underlyingPrice = new BigNumber(3570000/42423.832469).times(D18);
