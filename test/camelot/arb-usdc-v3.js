...
const Strategy = artifacts.require("CamelotV3NFTStrategyMainnet_ARB_USDC");
...
describe("Mainnet Camelot ARB-USDC V3 HODL in xGRAIL", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xd8dc994FE2b075c697e5051c89b713Bf15fa9294";
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        hodlPrice = new BigNumber(850).times(D18);
        underlyingPrice = new BigNumber(143010/0.000000182897371755).times(D18);
