...
const Strategy = artifacts.require("CamelotNitroStrategyMainnet_RELAY_ETH");
const IXGrail = artifacts.require("IXGrail")
const IVault = artifacts.require("IVault");

const D18 = new BigNumber(Math.pow(10, 18));

//This test was developed at blockNumber 126142300

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Camelot RELAY-ETH HODL in xGRAIL", function () {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x6b9F551Ce4cf0d0b28e1B9390838e8ef22eb2860";
  ...
  let relay = "0x1426CF37CAA89628C4DA2864e40cF75E6d66Ac6b";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xBbcF0B7F070B170909C9ff430878e92ceAd990F3");
  ...
  before(async function () {
    ...
    [controller, vault, strategy, potPool] = await setupCoreProtocol({
      ...
      "liquidation": [
        { "camelot": [relay, weth, grail] },
        { "camelot": [grail, weth, relay] }
      ],
      "ULOwner": addresses.ULOwner
    });
  ...
  describe("Happy path", function () {
    it("Farmer should earn money", async function () {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        hodlPrice = new BigNumber(760.26).times(D18);
        underlyingPrice = new BigNumber(103683 / 3466.78696).times(D18);
