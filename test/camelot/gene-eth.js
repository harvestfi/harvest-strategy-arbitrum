...
const Strategy = artifacts.require("CamelotNitroStrategyMainnet_GENE_ETH");
const IXGrail = artifacts.require("IXGrail")
const IVault = artifacts.require("IVault");

const D18 = new BigNumber(Math.pow(10, 18));

//This test was developed at blockNumber 104050800

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Camelot GENE-ETH HODL in xGRAIL", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x8EE355abDB31DC131b4c6B3001dD4762F613BcF8";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xa0c79678bCFbEA0a358D5FeA563100893C37a848");
  ...
  before(async function() {
    ...
    [controller, vault, strategy, potPool] = await setupCoreProtocol({
      ...
      "liquidation": [
        {"camelot": [gnome, weth, grail]},
        {"camelot": [grail, weth, gene]}
      ]
    });
