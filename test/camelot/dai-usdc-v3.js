...
const Strategy = artifacts.require("CamelotV3NitroStrategyMainnet_DAI_USDC");
...
describe("Mainnet Camelot DAI-USDC V3 HODL in xGRAIL", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x2766Ba1B6772d23E1F58260a1dF57bFFB4661953");
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        underlyingPrice = new BigNumber(1170000/1171849.092702).times(D18);
