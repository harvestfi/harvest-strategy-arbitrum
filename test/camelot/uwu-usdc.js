...
const Strategy = artifacts.require("CamelotNitroStrategyMainnet_UWU_USDC");
const IXGrail = artifacts.require("IXGrail")
const IVault = artifacts.require("IVault");

const D18 = new BigNumber(Math.pow(10, 18));

//This test was developed at blockNumber 117838900

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Camelot UWU-USDC HODL in xGRAIL", function () {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xDD9cA075Bc4730c930B1baA1f84B4010d2dA7e38";
  ...
  let uwu = "0x05d35769a222AfFd6185e20F3f3676Abde56C25F";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x6B8b78554Db2f017CCA749dad38E445cd8A3b5B4");
  ...
  before(async function () {
    ...
    [controller, vault, strategy, potPool] = await setupCoreProtocol({
      ...
      "liquidation": [
        {"camelot": [usdc, grail]},
        {"camelot": [grail, usdc]},
        {"camelot": [uwu, usdc, grail]},
        {"camelot": [grail, usdc, uwu]}
      ],
      "ULOwner": addresses.ULOwner
    });
  ...
  describe("Happy path", function () {
    it("Farmer should earn money", async function () {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        underlyingPrice = new BigNumber(11120.78 / 0.02515672).times(D18);
