...
const Strategy = artifacts.require("CamelotNitroStrategyMainnet_UMAMI_ETH");
const IXGrail = artifacts.require("IXGrail")
const IVault = artifacts.require("IVault");

const D18 = new BigNumber(Math.pow(10, 18));

//This test was developed at blockNumber 126136900

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Camelot UMAMI-ETH HODL in xGRAIL", function () {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x450EE27BD4eba22c80b449F387aa4eaF066E6E71";
  ...
  let umami = "0x1622bF67e6e5747b81866fE0b85178a93C7F86e3";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xa1e48225215d9e656F4f9d779fc32817C50de0E5");
  ...
  before(async function () {
    ...
    [controller, vault, strategy, potPool] = await setupCoreProtocol({
      ...
      "liquidation": [
        { "camelot": [umami, weth, grail] },
        { "camelot": [grail, weth, umami] }
      ],
      "ULOwner": addresses.ULOwner
    });
  ...
  describe("Happy path", function () {
    it("Farmer should earn money", async function () {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        hodlPrice = new BigNumber(760.55).times(D18);
        underlyingPrice = new BigNumber(168255.79 / 0.0208312).times(D18);
