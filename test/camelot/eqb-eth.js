...
const Strategy = artifacts.require("CamelotNitroStrategyMainnet_EQB_ETH");
...
describe("Mainnet Camelot EQB-ETH HODL in xGRAIL", function () {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x63F819A59471d460071D09D953385a027DaaF87a";
  ...
  let eqb = "0xBfbCFe8873fE28Dfa25f1099282b088D52bbAD9C";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x69B545997BD6aBC81CaE39Fe9bdC94d2242a0f92");
  ...
  before(async function () {
    ...
    [controller, vault, strategy, potPool] = await setupCoreProtocol({
      ...
      "liquidation": [
        { "camelot": [eqb, weth, grail] },
        { "camelot": [grail, weth, eqb] }
      ],
      "ULOwner": addresses.ULOwner
    });
  ...
  describe("Happy path", function () {
    it("Farmer should earn money", async function () {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        hodlPrice = new BigNumber(765.19).times(D18);
        underlyingPrice = new BigNumber(489741.27 / 17612.752391).times(D18);
