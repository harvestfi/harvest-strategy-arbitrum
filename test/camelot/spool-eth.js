...
const Strategy = artifacts.require("CamelotNitroStrategyMainnet_SPOOL_ETH");
const IXGrail = artifacts.require("IXGrail");
const IVault = artifacts.require("IVault");

const D18 = new BigNumber(Math.pow(10, 18));

//This test was developed at blockNumber 98458100

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Camelot SPOOL-ETH HODL in xGRAIL", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x0AE7a4b28a7859242adD48417Cde69582e41b99f";
  let spool = "0xECA14F81085e5B8d1c9D32Dcb596681574723561";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x835785C823e3c19c37cb6e2C616C278738947978");
  ...
  before(async function() {
    ...
    [controller, vault, strategy, potPool] = await setupCoreProtocol({
      ...
      "liquidation": [
        {"camelot": [spool, weth, usdc, grail]},
        {"camelot": [grail, usdc, weth, spool]}
      ]
    });
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        hodlPrice = new BigNumber(1517).times(D18);
        underlyingPrice = new BigNumber(384000/5814.680118).times(D18);
