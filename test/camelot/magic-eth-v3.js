...
const Strategy = artifacts.require("CamelotV3NitroStrategyMainnet_MAGIC_ETH");
const IXGrail = artifacts.require("IXGrail");
const IVault = artifacts.require("IVault");

const D18 = new BigNumber(Math.pow(10, 18));

//This test was developed at blockNumber 183020000

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Camelot MAGIC-ETH V3 HODL in xGRAIL", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x8e3E5238c4B002822C3e99c5B256A646C7eA3158";
  ...
  let magic = "0x539bdE0d7Dbd336b79148AA742883198BBF60342";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x6F8401bd348B3f8cDabc8C81dbD0Ac255abCB4e5");
  ...
  before(async function() {
    ...
    [controller, vault, strategy, potPool] = await setupCoreProtocol({
      ...
      "liquidation": [
        {"camelotV3": [grail, usdc, weth, magic]},
      ]
    });
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        underlyingPrice = new BigNumber(1570000/0.00000156298375781).times(D18);
