...
const Strategy = artifacts.require("CamelotNFTStrategyMainnet_GRAIL_ARB");
...
describe("Mainnet Camelot GRAIL-ARB HODL in xGRAIL", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x0f6A3521142A567675926efc06a542e561945193";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xC9da32C3b444F15412F7FeAC6104d1E258D23B1b");
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        hodlPrice = new BigNumber(1410).times(D18);
        underlyingPrice = new BigNumber(723140/8667.359735).times(D18);
