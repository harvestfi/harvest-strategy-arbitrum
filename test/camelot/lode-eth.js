...
const Strategy = artifacts.require("CamelotNitroStrategyMainnet_LODE_ETH");
...
describe("Mainnet Camelot LODE-ETH HODL in xGRAIL", function () {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xAb9F4D19F6F22B152153A1d701A1492255d79387";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x49bB23DfAe944059C2403BCc255c5a9c0F851a8D");
  ...
  before(async function () {
    ...
    [controller, vault, strategy, potPool] = await setupCoreProtocol({
      ...
      "liquidation": [
        { "camelot": [lode, weth, grail] },
        { "camelot": [grail, weth, lode] }
      ],
      "ULOwner": addresses.ULOwner
    });
  ...
  describe("Happy path", function () {
    it("Farmer should earn money", async function () {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        underlyingPrice = new BigNumber(451777.47 / 10774.076).times(D18);
