...
const Strategy = artifacts.require("CamelotV3NitroStrategyMainnet_ARB_USDC");
...
describe("Mainnet Camelot ARB-USDC V3 HODL in xGRAIL", function() {
  ...
  before(async function() {
    ...
    [controller, vault, strategy, potPool] = await setupCoreProtocol({
      ...
      "existingRewardPoolAddress": "0x39bC1a41e9b77De48bb1D6cBDb5E36635c4c28b9",
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        underlyingPrice = new BigNumber(1440000/0.000001904267492796).times(D18);
