...
const Strategy = artifacts.require("CamelotNFTStrategyMainnet_GRAIL_USDC");
...
describe("Mainnet Camelot GRAIL-USDC HODL in xGRAIL", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xDd1dC0246a9fe9B74dEF0EA8FdDff60be09fD506";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x87425D8812f44726091831a9A109f4bDc3eA34b4");
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        underlyingPrice = new BigNumber(10743331/0.125464).times(D18);
