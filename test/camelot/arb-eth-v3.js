...
const Strategy = artifacts.require("CamelotV3NitroStrategyMainnet_ARB_ETH");
...
describe("Mainnet Camelot ARB-ETH V3 HODL in xGRAIL", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x265E8D3b0F3a6b34D745cDAB26bcf6072762d4B4";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x863cb3E55526Fa2F7e6b04ecf21Ea39143AC8056");
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        underlyingPrice = new BigNumber(2930000/2739928.73766).times(D18);
