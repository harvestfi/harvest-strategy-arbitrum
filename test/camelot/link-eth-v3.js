...
const Strategy = artifacts.require("CamelotV3NitroStrategyMainnet_LINK_ETH");
...
describe("Mainnet Camelot LINK-ETH V3 HODL in xGRAIL", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xF3557102C0cCBE07EE237B6eE70984f313886432");
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        underlyingPrice = new BigNumber(661880/18640.298229).times(D18);
