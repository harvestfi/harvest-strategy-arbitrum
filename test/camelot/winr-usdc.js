...
const Strategy = artifacts.require("CamelotNitroStrategyMainnet_WINR_USDC");
const IXGrail = artifacts.require("IXGrail");
const IVault = artifacts.require("IVault");

const D18 = new BigNumber(Math.pow(10, 18));

//This test was developed at blockNumber 97436750

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Camelot WINR-USDC HODL in xGRAIL", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xe061Dd60ccAd674113fa25E3d1815D0a9cF24B51";
  let winr = "0xD77B108d4f6cefaa0Cae9506A934e825BEccA46E";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xAa6d06CeB39132b720b54259B70F41f9C975782A");
  ...
  before(async function() {
    ...
    [controller, vault, strategy, potPool] = await setupCoreProtocol({
      ...
      "liquidation": [
        {"camelot": [winr, usdc, grail]},
        {"camelot": [grail, usdc, winr]}
      ]
    });
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        underlyingPrice = new BigNumber(2472400/7.058081).times(D18);
