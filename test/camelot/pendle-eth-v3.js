...
const Strategy = artifacts.require("CamelotV3NitroStrategyMainnet_PENDLE_ETH");
...
describe("Mainnet Camelot PENDLE-ETH V3 HODL in xGRAIL", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xFf378310B278a66660480D532c7144EFEC644773";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x05F3ABD2B008e8b36a410F3C42E703cB776CeCD0");
  ...
  before(async function() {
    ...
    [controller, vault, strategy, potPool] = await setupCoreProtocol({
      ...
      "liquidation": [
        {"camelotV3": [grail, usdc, weth, pendle]},
      ]
    });
