...
const Strategy = artifacts.require("CamelotV3NitroStrategyMainnet_ETH_USDT");
const IXGrail = artifacts.require("IXGrail");
const IVault = artifacts.require("IVault");

const D18 = new BigNumber(Math.pow(10, 18));

//This test was developed at blockNumber 138121400

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Camelot ETH-USDT V3 HODL in xGRAIL", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xE6Fb2B218385FF1FFbA914775A35c1A121446CEF";
  ...
  before(async function() {
    ...
    [controller, vault, strategy, potPool] = await setupCoreProtocol({
      ...
      "existingRewardPoolAddress": "0x7e4d7C473d090ff0C70ee41A50116e0b7463EB46",
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        underlyingPrice = new BigNumber(665750/0.000000707360657979).times(D18);
