...
const Strategy = artifacts.require("CamelotNitroStrategyMainnet_SILO_ETH");
...
describe("Mainnet Camelot SILO-ETH HODL in xGRAIL", function() {
  let accounts;
  ...
  let silo = "0x0341C0C0ec423328621788d4854119B97f44E391";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xE01E0B5C707EdEE3FFC10b464115cC20073817A2");
  ...
  before(async function() {
    ...
    [controller, vault, strategy, potPool] = await setupCoreProtocol({
      ...
      "liquidation": [
        {"camelot": [silo, weth, usdc, grail]},
        {"camelot": [grail, usdc, weth, silo]}
      ]
    });
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        underlyingPrice = new BigNumber(740000/31787.747403).times(D18);
