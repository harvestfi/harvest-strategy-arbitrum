...
const Strategy = artifacts.require("CamelotNitroStrategyMainnet_THALES_ETH");
const IXGrail = artifacts.require("IXGrail")
const IVault = artifacts.require("IVault");

const D18 = new BigNumber(Math.pow(10, 18));

//This test was developed at blockNumber 126111400

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Camelot THALES-ETH HODL in xGRAIL", function () {
  let accounts;
  ...
  let thales = "0xE85B662Fe97e8562f4099d8A1d5A92D4B453bF30";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x8971dFb268B961a9270632f28B24F2f637c94244");
  ...
  before(async function () {
    ...
    [controller, vault, strategy, potPool] = await setupCoreProtocol({
      ...
      "liquidation": [
        { "camelot": [thales, weth, grail] },
        { "camelot": [grail, weth, thales] }
      ],
      "ULOwner": addresses.ULOwner
    });
  ...
  describe("Happy path", function () {
    it("Farmer should earn money", async function () {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        hodlPrice = new BigNumber(775.69).times(D18);
        underlyingPrice = new BigNumber(337939.5 / 6555.03).times(D18);
