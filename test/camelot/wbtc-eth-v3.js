...
const Strategy = artifacts.require("CamelotV3NitroStrategyMainnet_WTBC_ETH");
...
describe("Mainnet Camelot WBTC-ETH V3 HODL in xGRAIL", function() {
  let accounts;
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        underlyingPrice = new BigNumber(1790000/936.174718).times(D18);
