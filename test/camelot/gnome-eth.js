...
const Strategy = artifacts.require("CamelotNitroStrategyMainnet_GNOME_ETH");
const IXGrail = artifacts.require("IXGrail")
const IVault = artifacts.require("IVault");

const D18 = new BigNumber(Math.pow(10, 18));

//This test was developed at blockNumber 104025800

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Camelot GNOME-ETH HODL in xGRAIL", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x7D96Db90AcECB5E080eDE67493CCB2ebd6f07Ca6";
  ...
  let gene = "0x59A729658e9245B0cF1f8Cb9fb37945D2B06ea27";
  let gnome = "0x7698Ac5D15bb3Ba7185adCBff32A80ebD9d0709B";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x60F7116d7c451ac5a5159F60Fc5fC36336b742c4");
  ...
  before(async function() {
    ...
    [controller, vault, strategy, potPool] = await setupCoreProtocol({
      ...
      "liquidation": [
        {"camelot": [gene, weth, grail]},
        {"camelot": [grail, weth, gnome]}
      ]
    });
