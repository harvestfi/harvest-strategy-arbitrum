...
const Strategy = artifacts.require("LodestarFoldStrategyMainnet_ETH");

// Developed and tested at blockNumber 128892450

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Lodestar Fold ETH", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x66F38834895920589f66a8EaBc2b6A543B0EcA24";
