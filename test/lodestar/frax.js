...
const Strategy = artifacts.require("LodestarFoldStrategyMainnet_FRAX");

// Developed and tested at blockNumber 128892450

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Lodestar Fold FRAX", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xf791A4dC03bF89bf6b20482163Db794AE3590AAf";
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [
        {"camelot": [lode, weth]},
        {"uniV3": [weth, usdt, underlying.address]},
      ]
    });
