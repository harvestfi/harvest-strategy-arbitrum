...
const Strategy = artifacts.require("LodestarFoldStrategyMainnet_DAI");

// Developed and tested at blockNumber 128892450

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Lodestar Fold DAI", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x06594c6345f0e4E55840e269B82772960b157650";
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [
        {"camelot": [lode, weth]},
        {"camelot": [lode, weth, usdc, underlying.address]},
      ]
    });
