...
const Strategy = artifacts.require("LodestarFoldStrategyMainnet_WBTC");

// Developed and tested at blockNumber 128892450

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Lodestar Fold WBTC", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x8C84CF0D005559e18a702700e7436dBb2d7Df189";
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [
        {"camelot": [lode, weth]},
        {"camelot": [lode, weth, underlying.address]}
      ]
    });
