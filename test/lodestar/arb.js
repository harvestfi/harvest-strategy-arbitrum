...
const Strategy = artifacts.require("LodestarFoldStrategyV2Mainnet_ARB");

// Developed and tested at blockNumber 167374350

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Lodestar Fold ARB", function() {
  let accounts;
  ...
  async function setupBalance(){
    ...
    farmerBalance = new BigNumber(10e18)
